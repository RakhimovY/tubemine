...
/*
  ...
  active path is in the suppression list. Other routes (landing,
  pricing, oauth-intro, privacy, terms, etc.) keep their existing public
  header unchanged. Uses the locale-aware pathname helper from
